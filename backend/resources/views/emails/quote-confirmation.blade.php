                ...
                <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:16px;overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            <h1 style="font-size:20px;color:#050A22;margin:0 0 16px;">Merci pour votre demande, {{ $quote->client_name }} !</h1>
                            <p style="font-size:14px;line-height:1.6;margin:0 0 16px;">
                                Nous avons bien reçu votre demande de devis. Notre équipe l'étudie et vous recontactera sous 24h.
                            </p>
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#F9FAFB;border-radius:8px;padding:16px;margin-bottom:16px;">
                                <tr>
                                    <td style="font-size:13px;color:#9CA3AF;padding-bottom:4px;">Référence</td>
                                </tr>
                                <tr>
                                    <td style="font-size:16px;font-weight:700;color:#050A22;">{{ $quote->reference }}</td>
                                </tr>
                            </table>
                            ...
                            <p style="font-size:14px;line-height:1.6;margin:0 0 24px;">{{ $quote->project_description }}</p>
